...
Replace "(Comments?)" with either Ubuntu 12.04 or Ubuntu 14.04:
    I would prefer to be graded on: Ubuntu 14.04
Replace "(Comments?)" with either VMware, VirtualBox, Vagrant, or Other (please specify):
    I would prefer Ubuntu to be running on: VirtualBox
...
(C.1) faber_fs_thread_test (0 out of 3 pts)
    What is your kshell command to invoke faber_fs_thread_test(): faber_fs
(C.2) faber_directory_test (0 out of 2 pts)
    What is your kshell command to invoke faber_directory_test(): faber_dir
...
1)  Names and USC e-mail addresses of team members: 
 Wei-Lun Hsiao          hsia947@usc.edu
 Janhavi Hemant Karekar jkarekar@usc.edu
 Yue Qin                qiny@usc.edu
 Xin Wang               wang631@usc.edu
